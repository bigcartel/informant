...
The Informant gets most of his strength from Arby Melts and Prototype 1.6+ or jQuery 1.3+, so be sure to grab those. After that, just include these JavaScript vigilantes and let them handle the rest:
...
View the code for customization options.
